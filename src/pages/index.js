        ...
        <Layout title="Home" description={siteConfig.tagline}>
            <header className={styles.heroBanner} style={{ minHeight: headerHeight }}>
                ...
                >
                    ...
                    <p>
                        A <span className="text-purp">constantly curious</span> student at <span className="text-danger">NC State University </span>studying <span className="text-warning">mechanical engineering 🗜️</span> and{" "}
